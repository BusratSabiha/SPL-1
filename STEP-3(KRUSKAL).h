#ifndef STEP-3(KRUSKAL)_H_INCLUDED
#define STEP-3(KRUSKAL)_H_INCLUDED
#endif // STEP-3(KRUSKAL)_H_INCLUDED


void build_relation_matrix_kru(int edge,struct node pos1[])
{
    int i,cost;
    for(i=0; i<edge; i++)
    {
...
void for_self_experiment_kru(void)
{
    int gd=DETECT,gm;
    ...
    build_relation_matrix_kru(edge,pos1);
