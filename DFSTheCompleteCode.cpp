...
int main(void)
{
 ...
 /*if(ch=='n'||ch=='N')
 {
     printf("\n\n DO YOU WANNA VISIT THE PREVIOUS STEPS\n");
     printf("1:VIEW GRAPH ALGORITHM\n2:VISUALIZATION PART\n");
     printf("enter 1 or 2\n");
     int trap;
     scanf("%d",&trap);
     if(trap==1)print_BFSalgorithm();
     else if(trap==2)for_teaching_purpose();
 }*/
 ...
 /*if(ch=='n'||ch=='N')
 {
     ...
     else if(trap==3)for_self_experiment();
 }*/
